...
def enhance_palm_print(image_path):
    ...
    a = 1.5 # contrast = 5. Contrast control ( 0 to 127)
    b = 0   # brightness = 2. Brightness control (0-100)
    c = -0.5 
    sharp_img = cv2.addWeighted(adaptive_thresh_img, a, blurred_img, c, b)

    # Apply Non-Local Means Denoising
    denoised_img = cv2.fastNlMeansDenoising(sharp_img, None, h=10, searchWindowSize=21)
